...
def download_book_txt(request, book_id):
    ...
    response = render(request, template_name, context, content_type='text/plain; charset=utf-8')
    response.headers['Content-Disposition'] = f'attachment; filename="{book_id}.txt"'
    return response
